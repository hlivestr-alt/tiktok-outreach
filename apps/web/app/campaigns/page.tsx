...
export default function CampaignsPage() {
  ...
  return <div className="page">
    ...
    <section className="panel"><div className="panel-heading"><div><h2>Outreach campaigns</h2><p>Every campaign begins with discovery and a frozen preview.</p></div></div>
      ...
      {!error && campaigns.length === 0 ? <div className="empty"><div className="empty-icon"><Megaphone/></div><h3>No campaigns yet</h3><p>Create a campaign to test discovery, exclusions, one-click sending, and queue safety.</p><Link className="button primary" href="/campaigns/new">Create first campaign</Link></div> :
