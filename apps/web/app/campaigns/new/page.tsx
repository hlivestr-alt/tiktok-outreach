...
export default function NewCampaignPage() {
  ...
  const [form, setForm] = useState<Record<string, string>>({
    ...
    category: "beauty", rankingMetric: "GMV",
