...
export default function NewCampaignPage() {
  ...
  useEffect(() => { api<any>("/integrations/tiktok").then((value) => { const real = value.mode === "READ_ONLY"; setReadOnly(real); if (real) setForm((current) => ({ ...current, category: "" })); }).catch(() => undefined); }, []);
